function PersonDetails({imgurl, name, gender, country, year}) {
      ...
      <div className="flex flex-row mt-5">
        ...
        <div className="flex flex-col ">
            <div className="flex justify-between">
                <h1 className="text-white ml-10 text-3xl ">{name} </h1>
            ...
            <div className="flex flex-row m-10 font-3xl">
                <div className="flex flex-col">
                    <div className="flex flew-col">
                        ...
                        <p className="text-white ml-3">{gender}</p>
                    </div>
                    <div className="flex flew-col">
                        <h1 className="text-red-600">Nationality:</h1>
